...
void Game::display(SDL_Window*& window, SDL_Surface*& imageGame, SDL_Renderer*& RendrerGame, SDL_Texture*& texturegame, SDL_Event& event)
{
	...
	if (event.type == SDL_MOUSEBUTTONDOWN && checkinstruction == true)//dung checkinstruction để kiểm tra xem có phải là màn hình đang ở hướng dẫn không
	{
		...
		else if ((mouseX >= 354 && mouseX <= 534 && mouseY >= 288 && mouseY <= 338) && checknameimage == "instruction level easy.png")
		{
		...
		else if ((mouseX >= 354 && mouseX <= 534 && mouseY >= 294 && mouseY <= 346) && checknameimage == "instruction level medium.png")
		{
		...
		else if ((mouseX >= 350 && mouseX <= 533 && mouseY >= 296 && mouseY <= 348) && checknameimage == "instruction level hard.png")
		{
		...
		else if ((mouseX >= 354 && mouseX <= 534 && mouseY >= 322 && mouseY <= 370) && checknameimage == "instruction level hardest.png")
		{
	...
	//in ra màn hình chơi
	if (event.type == SDL_MOUSEBUTTONDOWN && checklevelselection == true)//dùng checklevelselection để kiểm tra xem có đang ở màn hình chính của level không
	{
